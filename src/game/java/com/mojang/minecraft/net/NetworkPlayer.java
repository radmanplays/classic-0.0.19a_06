...
public class NetworkPlayer extends Entity {
	...
	public void render(Textures var1, float var2) {
		...
		float var8 = this.yBodyRotO + (this.yBodyRot - this.yBodyRotO) * var2;
		float var3 = this.yRotO + (this.yRot - this.yRotO) * var2;
		float var4 = this.xRotO + (this.xRot - this.xRotO) * var2;
		var3 -= var8;
		GL11.glPushMatrix();
		float var5 = this.animStepO + (this.animStep - this.animStepO) * var2;
		float var6 = this.getBrightness();
		GL11.glColor3f(var6, var6, var6);
		var6 = 1.0F / 16.0F;
		float var7 = (float)(-Math.abs(Math.sin((double)var5 * 0.6662D)) * 5.0D - 23.0D);
		...
		this.zombieModel.render(var5, var3, var4);
		GL11.glEnable(GL11.GL_ALPHA_TEST);
		Font var9 = this.minecraft.font;
		GL11.glPopMatrix();
		GL11.glPushMatrix();
		...
		var9.draw(this.name, 0, 0, 5263440);
		GL11.glPopMatrix();
		GL11.glDisable(GL11.GL_TEXTURE_2D);
	}

	public void queue(byte var1, byte var2, byte var3, float var4, float var5) {
		this.moveQueue.add(new PlayerMove(((float)this.xp + (float)var1 / 2.0F) / 32.0F, ((float)this.yp + (float)var2 / 2.0F) / 32.0F, ((float)this.zp + (float)var3 / 2.0F) / 32.0F, (this.yRot + var4) / 2.0F, (this.xRot + var5) / 2.0F));
		this.xp += var1;
		this.yp += var2;
		this.zp += var3;
	...
	public void teleport(short var1, short var2, short var3, float var4, float var5) {
		this.moveQueue.add(new PlayerMove((float)(this.xp + var1) / 64.0F, (float)(this.yp + var2) / 64.0F, (float)(this.zp + var3) / 64.0F, (this.yRot + var4) / 2.0F, (this.xRot + var5) / 2.0F));
		this.xp = var1;
		this.yp = var2;
		this.zp = var3;
		this.moveQueue.add(new PlayerMove((float)this.xp / 32.0F, (float)this.yp / 32.0F, (float)this.zp / 32.0F, var4, var5));
	...
	public void queue(float var1, float var2) {
		this.moveQueue.add(new PlayerMove((this.yRot + var1) / 2.0F, (this.xRot + var2) / 2.0F));
